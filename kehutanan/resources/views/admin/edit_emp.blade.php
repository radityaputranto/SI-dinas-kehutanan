                                    ...
                                    <div class="form-group row {{ $errors->has('NAMA_EMP') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="nama_lengkap" placeholder="Nama Lengkap" name="NAMA_EMP" value="{{$emp->NAMA_EMP}}">
                                            </div>
                                    ...
                                    <div class="form-group row form-group row {{ $errors->has('email') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" id="email" placeholder="Email" name="email" value="{{$emp->email}}">
                                            </div>
                                            @if ($errors->has('email'))
                                    ...
                                    <div class="form-group row form-group row {{ $errors->has('password') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" id="pass" placeholder="Password" name="password" value="{{$emp->password}}">
                                            </div>
                                    ...
                                    <div class="form-group row form-group row {{ $errors->has('NOTELP_EMP') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="noTelp" placeholder="No Telp" name="NOTELP_EMP" value="{{$emp->NOTELP_EMP}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row form-group row {{ $errors->has('ALAMAT_EMP') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <textarea type="text" class="form-control" id="alamat" placeholder="Alamat" name="ALAMAT_EMP" >{{$emp->ALAMAT_EMP}}</textarea>
                                            </div>
                                        </div>
                                    </div>
