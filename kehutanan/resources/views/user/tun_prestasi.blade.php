                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        <p>Sub Total Tunjangan Prestasi : Rp. {{$data['PRESTASI_AWAL']-$data['denda_telat']-$data['denda_pul_cpt']+$data['tambahan_lembur']}}</p>
                                        <p>PPH (5%) : Rp. {{($data['PRESTASI_AWAL']-$data['denda_telat']-$data['denda_pul_cpt']+$data['tambahan_lembur'])*$data['PPH']}} </p>
                                        <hr>
