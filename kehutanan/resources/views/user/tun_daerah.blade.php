            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Tunjangan Daerah</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sistem Absensi dan tunjangan </a></li>
                            <li class="breadcrumb-item active">Tunjangan Daerah</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-block printableArea">
                            ...
                            <h3><b>Detail Tunjangan Daerah</b> <span class="pull-right">id : {{$data['ID_TUNJANGAN_EMP']}}</span></h3>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right"> Rp. {{$data['DAERAH_AWAL']}}</td>
                                                    <td class="text-right"> Rp. {{$data['DAERAH_AWAL']}} </td>
                                                </tr>
                                                <tr>
