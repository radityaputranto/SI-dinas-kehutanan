                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="{{url('profil')}}"><i class="ti-user"></i> My Profile</a></li>
                                    <li role="separator" class="divider"></li>
                                    <li role="separator" class="divider"></li>
                                    <li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a  href="{{url('home')}}" aria-expanded="false"><i class="mdi mdi-home-outline"></i><span class="hide-menu">Home</span></a>
                        </li>
                        <li>
                            <a  href="{{url('absensi')}}" aria-expanded="false"><i class="mdi mdi-fingerprint"></i><span class="hide-menu">Absensi</span></a>
                        </li>        
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('tun_daerah')}}">Daerah</a></li>
                                <li><a href="{{url('tun_pres')}}">Prestasi</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{url('uang_mkn')}}" aria-expanded="false"><i class="mdi mdi-food"></i><span class="hide-menu">Uang Makan</span></a>
                        </li>
                        <li>
